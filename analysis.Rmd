...
# imprting shortage
shortage <- read_excel("~/Documents/MPH Brown /2018 Fall PHP 1100/Data analysis/project/data/Book2.xlsx", 
                       sheet = "shortage")
...
# visualise correlation 
 ...
 corrplot(corr = merged_final2_corr_matrix, type = "upper" ,method = "square",
          tl.col="black", tl.srt=45, tl.cex = 1,
          p.mat = p.mat3, sig.level = 0.1, insig = "blank")
...
# best fit scatter plot
 ...
 scatter_docshort_cov <- merged_final2 %>%
   ggscatter( x = "doctors_shortage", y = "DALYs" , 
              add = "reg.line", conf.int = TRUE, 
              cor.coef = TRUE, cor.method = "pearson",
              xlab =  "Estimated Doctors Shortage as Density per 1000 population", ylab = "number of DALYs") +
   geom_point() +
  geom_text(label = merged_final2$location_name, size = 3, check_overlap = TRUE, hjust = 0.1, nudge_x = 0.01)
...
# linear model  
 ...
 lm_shortage <- lm(DALYs ~ doctors_shortage, data = merged_final2)
summary(lm_shortage)
```
